...
const CORNER_SQUARE_MAP: Record<string | number, CornerSquareType> = {
  ...
  1: "square",           // default
  2: "dot",              // dot (circle)
  3: "square",           // square (like border 1)
  4: "square",           // square
  5: "extra-rounded",    // extra-rounded
  6: "extra-rounded",    // shape1
  7: "square",           // shape2
  8: "dot",              // shape3
  9: "dot",              // shape4
  10: "extra-rounded",   // shape5
  11: "extra-rounded",   // shape6
  12: "dot",             // shape7
  13: "square",          // shape8
  14: "extra-rounded",   // shape9
  15: "dot",             // shape10
  16: "extra-rounded",   // shape11
};
