...
export default function LoginPage() {
  ...
  // Handle email/password login (custom auth)
  ...
  // Handle social login (Clerk OAuth)
  const handleSocialLogin = async (provider: 'oauth_google' | 'oauth_facebook' | 'oauth_linkedin_oidc') => {
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 bg-white">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            type="button"
            disabled
            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-gray-200 rounded-xl opacity-50 cursor-not-allowed"
          >
