...
import { QrCodeIcon, EnvelopeIcon, LockClosedIcon, EyeIcon, EyeSlashIcon } from '@heroicons/react/24/outline';
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 bg-white">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500">Enter with your networks or complete your data</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex justify-start">
            <Link href="/auth/forgot-password" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
              Have you forgotten your password? <span className="underline">Click here</span>
            </Link>
          </div>
